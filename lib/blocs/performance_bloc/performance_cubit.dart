...
class PerformanceCubit extends Cubit<AppStates> {
  ...
  Paginated get _active => switch (tab) {
    PerformanceTab.records => records,
    PerformanceTab.kpis => kpis,
    PerformanceTab.salaries => salaries,
  };
  ...
  Future<void> fetch() async {
    ...
    switch (tab) {
      case PerformanceTab.records:
        ...
        records = Paginated.read<KpiRecord>(
          r.body,
          'kpi_records',
          KpiRecord.fromJson,
        );
      ...
      case PerformanceTab.salaries:
        ...
        if (!r.success) return emit(AppFailure(msg: r.message));
        salaries = Paginated.read<Salary>(r.body, 'salaries', Salary.fromJson);
        break;
    }
  ...
  Future<void> _loadKpis() async {
    ...
    if (r.success) {
      kpis = Paginated.read<Kpi>(r.body, 'kpis', Kpi.fromJson);
    }
  }
