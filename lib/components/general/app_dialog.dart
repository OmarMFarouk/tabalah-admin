...
class AppDialog<C extends Cubit<AppStates>> extends StatelessWidget {
  ...
  /// False while the dialog is still asking a question rather than
  /// collecting an answer — a save button over a step that has nothing to
  /// save reads as a way to skip it.
  final bool showSave;
  ...
  Widget build(BuildContext context) {
    return BlocListener<C, AppStates>(
      ...
      child: Directionality(
        ...
        // Dialogs are their own route, so the screen's SelectionArea is not
        // an ancestor - they need one of their own for a reference number
        // or an error message to be copyable.
        child: SelectionArea(
          child: AlertDialog(
            ...
            actions: [
              TextButton(
                ...
                child: Text(
                  'إلغاء',
                  style: TextStyle(color: GlobalColors.textSecondary(context)),
                ),
              ),
              if (showSave)
