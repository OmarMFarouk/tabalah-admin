...
class PaymentSource {
  ...
  /// English rendering, shown to members running the app in English. Blank
  /// means the backend falls back to the Arabic name at checkout.
  String? nameEn;
  ...
  factory PaymentSource.fromJson(Map<String, dynamic> json) => PaymentSource(
    id: asInt(json['id']),
    // `name_ar` is the raw primary column; `name` is what the API resolved
    // for the request's language. The panel edits the raw columns.
  ...
  Map<String, dynamic> toJson() => {
    ...
    // Sent even when empty so clearing the English field clears it
    // server-side instead of silently keeping the old translation.
...
class Payment {
  ...
  factory Payment.fromJson(Map<String, dynamic> json) {
    ...
    return Payment(
      ...
      createdAt: asDateTime(json['paid_at'] ?? json['created_at']),
      refundedAt: asDateTime(json['refunded_at']),
