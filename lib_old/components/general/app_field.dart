  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: TextStyle(
          color: GlobalColors.textSecondary(context).withOpacity(0.6),
          fontSize: 12,
        ),
...
class AppDropdown<T> extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Guard against a value that isn't in the list — Flutter asserts on it.
    ...
    return DropdownButtonFormField<T>(
      ...
      hint: Text(
        emptyLabel ?? 'اختر...',
        style: TextStyle(
          color: GlobalColors.textSecondary(context).withOpacity(0.7),
          fontSize: 13,
        ),
      ),
      decoration: InputDecoration(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: FilterChip(
        ...
        selectedColor: GlobalColors.accent.withOpacity(0.18),
