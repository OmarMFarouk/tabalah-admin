      ...
      child: Scaffold(
        ...
        body: BlocConsumer<FinanceCubit, AppStates>(
          ...
          builder: (ctx, state) {
            ...
            final canWrite = me?.isAdmin ?? false;
          ...
          children: [
            ...
            SizedBox(
              ...
              child: AppDropdown<User>(
                value: pickWhere(AppGlobals.members, (u) => u.userId == c.memberFilter),
            ...
            SizedBox(
              ...
              child: AppDropdown<PaymentSource>(
                value: pickWhere(AppGlobals.paymentSources, (s) => s.id == c.sourceFilter),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: AppDropdown<Membership>(
                value: pickWhere(AppGlobals.memberships, (m) => m.id == c.membershipFilter),
              ...
              children: [
                if (enrollment != null)
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: GlobalColors.green.withOpacity(0.08),
                ...
                dialogRow([
                  ...
                  AppDropdown<PaymentSource>(
                    value: pickWhere(c.activeSources, (s) => s.id == c.formSourceId),
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                padding: const EdgeInsets.all(12),
                decoration: BoxDecoration(
                  color: GlobalColors.red.withOpacity(0.08),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
              ...
              children: [
                if (enrollment == null) ...[
                  ...
                  AppDropdown<Membership>(
                    value: pickWhere(AppGlobals.memberships, (m) => m.id == c.formMembershipId),
                    items: AppGlobals.memberships
                        .where((m) => m.isActive)
                        .toList(),
                    labelOf: (m) =>
