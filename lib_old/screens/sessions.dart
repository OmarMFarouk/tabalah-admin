...
class _SessionsView extends StatelessWidget {
  ...
  Widget _board(BuildContext ctx, SessionsCubit c, bool loading) {
    if (loading && c.board.values.every((l) => l.isEmpty)) {
      return Center(child: CircularProgressIndicator(color: GlobalColors.accent));
    }
                ...
                builder: (dctx, candidate, __) {
                  ...
                  return Container(
                    decoration: BoxDecoration(
                      color: hot
                          ? _sessionColor(status).withOpacity(0.08)
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _sessionColor(status).withOpacity(0.15),
            ...
            child: Column(
              ...
              children: [
                ...
                AppDropdown<Membership>(
                  value: pickWhere(AppGlobals.memberships, (m) => m.id == membershipId),
                  items: AppGlobals.memberships,
                  labelOf: (m) => m.name ?? '—',
                  label: 'الاشتراك *',
                  icon: Icons.card_membership_rounded,
